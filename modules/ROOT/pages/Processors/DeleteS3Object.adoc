= DeleteS3Object 2.2.0

Удаляет файл из Amazon S3 Bucket. Если попытаться удалить файл, который не существует, FlowFile будет направлен в success.
...
* US West (N. California) (Западная часть США (Калифорния)): AWS Region Code : us-west-1 

* US West (Oregon) (Западная часть США (Орегон)): AWS Region Code : us-west-2 
...
[horizontal]
*DESCRIPTION (Описание):*:: The Version of the Object to delete
