...
[horizontal]
*DESCRIPTION (Описание):*:: The ID of the folder from which to pull list of files.
...
[horizontal]
*DESCRIPTION (Описание):*:: When 'true', will include list of files from sub-folders. Otherwise, will return only files that are within the folder defined by the 'Folder ID' property.
