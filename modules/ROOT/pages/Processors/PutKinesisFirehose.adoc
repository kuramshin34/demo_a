...
************************************************
[horizontal]
*DISPLAY NAME (Отображаемое наименование):*:: Amazon Kinesis Firehose Delivery Stream Name
...
************************************************
[horizontal]
*DISPLAY NAME (Отображаемое наименование):*:: Max message buffer size

[horizontal]
*DESCRIPTION (Описание):*:: Max message buffer
