...
Позволяет пользователю предоставить экземпляр скриптованного LookupService для обогащения записей из входящего потока файлов.
...
|Обновляет свойство скриптового движка, указанное ключом Dynamic Property, с помощью значения, указанного значением Dynamic Property
